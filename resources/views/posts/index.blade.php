...
@section('title','Markedia - Marketing Blog Temple :: Home')

@section('header')
        <section id="cta" class="section" style="background-image: url('{{ asset('uploads/armo.jpg') }}'); background-size: cover; background-position: center;">
            <div class="container">
                <div class="row">
