...
@section('title','Markedia - Marketing Blog Temple :: Category' . $tag->title)
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 hidden-xs-down hidden-sm-down">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('posts.home')}}">Home</a></li>
                            ...
                            @foreach($posts as $post)
                                <div class="blog-box wow fadeIn">
                                    <div class="post-media">
                                        <a href="{{route('posts.single',['slug'=>$tag->slug])}}" title="">
